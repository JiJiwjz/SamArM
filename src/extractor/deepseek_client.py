...
class DeepSeekClient:
    ...
    async def summarize_paper(self, title: str, summary: str, 
        ...
        if not system_prompt:
            system_prompt = """你是一个学术论文解读专家。请阅读以下论文的标题与摘要，用中文撰写一段论文解读。
要求：
